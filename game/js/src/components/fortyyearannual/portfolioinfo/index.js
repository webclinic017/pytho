    ...
    <Panel>
      <div className="pure-g">
        <span
          ...
          <Title light align="right">Value</Title>
          <Text data-testid="forty-portfoliovalue" number highlight>{ifPortfolioValue}</Text>
        </span>
        <span 
          ...
          <Title light align="right">Period</Title>
          <Text data-testid="forty-portfolioperiod" number highlight>{ifPeriod}</Text>
        </span>
      </div>
    </Panel>
  )
